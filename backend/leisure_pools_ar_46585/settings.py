"""
Django settings for leisure_pools_ar_46585 project.
...
ROOT_URLCONF = 'leisure_pools_ar_46585.urls'
...
WSGI_APPLICATION = 'leisure_pools_ar_46585.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "leisure_pools_ar_46585 API",
    "DESCRIPTION": "API documentation for leisure_pools_ar_46585 App",
    "VERSION": "v1",
}
